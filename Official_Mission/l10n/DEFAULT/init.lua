...
local savefile = 'pretense_1.0.json'
if lfs then 
	...
	upgrades = {
		basic = {
			tent = Preset:new({
				...
				cost = 1500,
				type = 'upgrade',
				templateCategory = TemplateDB.type.static
			}),
			comPost = Preset:new({
				display = 'Barracks',
				cost = 1500,
		...
		airdef = {
			...
			ewr = Preset:new({
				display = 'Early Warning Radar',
				cost = 2500,
				type = 'upgrade',
				templateCategory = TemplateDB.type.group
			})
		}
	},
	defenses = {
...
zones.batumi:defineUpgrades({
    [1] = { --red side
        presets.upgrades.basic.comPost:extend({ 
            name = 'batumi-com-red',
            products = {
                presets.defenses.infantry:extend({ name='batumi-infantry-red' })
            }
        }),
    }, 
    [2] = --blue side
    {	
        presets.upgrades.basic.comPost:extend({ 
            ...
            products = {
                presets.defenses.infantry:extend({ name='batumi-infantry-blue' })
            }
        }),
        ...
        presets.upgrades.airdef.comCenter:extend({ 
            ...
            products = {
                presets.defenses.sam:extend({ name='batumi-sam-blue' }),
...
zones.nalchik:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='nalchik-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='nalchik-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='nalchik-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='nalchik-airdef-blue'}),
...
zones.whiskey:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='whiskey-garrison-red'})
            }
        }),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='whiskey-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.humara:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='humara-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='humara-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.farm:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            name='farm-tent-red',
            products = {
                presets.defenses.infantry:extend({ name='farm-garrison-red'})
            }
        }),
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            name='farm-tent-blue',
            products = {
                presets.defenses.infantry:extend({ name='farm-garrison-blue'})
            }
        }),
        presets.upgrades.supply.farm:extend({
...
zones.prohladniy:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='prohladniy-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='prohladniy-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.distillery:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='distillery-garrison-red'})
            }
        }),
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='distillery-garrison-blue'})
            }
        }),
        presets.upgrades.supply.factory:extend({
...
zones.victor:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='victor-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='victor-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.powerplant:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='powerplant-garrison-red'})
            }
        }),
        presets.upgrades.supply.powerplant:extend({
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='powerplant-garrison-blue'})
            }
        }),
        presets.upgrades.supply.powerplant:extend({
...
zones.delta:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='delta-tent-red',
            products = {
                presets.defenses.infantry:extend({name='delta-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='delta-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='delta-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.quebec:defineUpgrades({
    [1] =  
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='quebec-sam-red'})
            }
        })
    },
    [2] = 
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='quebec-sam-blue'})
            }
        })
    }
})
...
zones.romeo:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='romeo-tent-red',
            products = {
                presets.defenses.infantry:extend({name='romeo-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='romeo-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='romeo-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.bravo:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='bravo-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
            name='bravo-fuel-red',
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({ name='bravo-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='bravo-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({ name='bravo-airdef-blue'}),
...
zones.kobuleti:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='kobuleti-garrison-red'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='kobuleti-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='kobuleti-garrison-blue'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='kobuleti-airdef-blue'}),
...
zones.xray:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='xray-tent-red',
            products = {
                presets.defenses.infantry:extend({name='xray-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='xray-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='xray-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='xray-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='xray-fuel-blue',
...
zones.mike:defineUpgrades({
    [1] =  
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mike-sam-red'})
            }
        })
    },
    [2] = 
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mike-sam-blue'})
            }
        })
    }
})
...
zones.yankee:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='yankee-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='yankee-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.gudauta:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='gudauta-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='gudauta-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='gudauta-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='gudauta-airdef-blue'}),
...
zones.mineralnye:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='mineralnye-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mineralnye-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='mineralnye-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mineralnye-airdef-blue'}),
...
zones.sierra:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='sierra-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='sierra-sam-red'}),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='sierra-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='sierra-sam-blue'}),
...
zones.malgobek:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='malgobek-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='malgobek-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.sukhumi:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='sukhumi-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='sukhumi-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='sukhumi-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='sukhumi-airdef-blue'}),
...
zones.juliett:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='juliett-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='juliett-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.tango:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='tango-tent-red',
            products = {
                presets.defenses.infantry:extend({name='tango-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
            name='tango-fuel-red',
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='tango-sam-red'}),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='tango-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='tango-sam-blue'}),
...
zones.senaki:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='senaki-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='senaki-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='senaki-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='senaki-airdef-blue'}),
...
zones.kutaisi:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='kutaisi-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='kutaisi-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='kutaisi-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='kutaisi-airdef-blue'}),
...
zones.ochamchira:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='ochamchira-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='ochamchira-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.lima:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='lima-tent-red',
            products = {
                presets.defenses.infantry:extend({name='lima-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='lima-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='lima-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='lima-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='lima-fuel-blue',
...
zones.zulu:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='zulu-tent-red',
            products = {
                presets.defenses.infantry:extend({name='zulu-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='zulu-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='zulu-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='zulu-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='zulu-fuel-blue',
...
zones.lentehi:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='lentehi-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='lentehi-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.foxtrot:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='foxtrot-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='foxtrot-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.echo:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='echo-tent-red',
            products = {
                presets.defenses.infantry:extend({name='echo-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='echo-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='echo-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='echo-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='echo-fuel-blue',
...
zones.india:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='india-tent-red',
            products = {
                presets.defenses.infantry:extend({name='india-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='india-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='india-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.beslan:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='beslan-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='beslan-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='beslan-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='beslan-airdef-blue'}),
...
zones.digora:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='digora-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='digora-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.papa:defineUpgrades({
    [1] =  
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='papa-sam-red'})
            }
        })
    },
    [2] = 
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='papa-sam-blue'})
            }
        })
    }
})
...
zones.hotel:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='hotel-tent-red',
            products = {
                presets.defenses.infantry:extend({name='hotel-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='hotel-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='hotel-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.weapondepot:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='weapons-garrison-red'})
            }
        }),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='weapons-garrison-blue'})
            }
        }),
        presets.upgrades.supply.ammoDepot:extend({
...
zones.charlie:defineUpgrades({
    [1] =  
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='charlie-garrison-red'})
            }
        }),
        presets.upgrades.airdef.comCenter:extend({
            name='charlie-comcenter-red',
            products = {
                presets.defenses.sam:extend({ name='charlie-sam-red'})
            }
        })
    },
    [2] = 
    {
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='charlie-sam-blue'})
            }
        })
    }
})
...
zones.mine:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            name='mine-tent-red',
            products = {
                presets.defenses.infantry:extend({ name='mine-garrison-red'})
            }
        }),
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            name='mine-tent-blue',
            products = {
                presets.defenses.infantry:extend({ name='mine-garrison-blue'})
            }
        }),
        presets.upgrades.supply.excavator:extend({
...
zones.refinery:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='refinery-garrison-red'})
            }
        }),
        presets.upgrades.supply.refinery:extend({
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='refinery-garrison-blue'})
            }
        }),
        presets.upgrades.supply.refinery:extend({
...
zones.cherkessk:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='cherkessk-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='cherkessk-sam-red'}),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='cherkessk-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='cherkessk-sam-blue'}),
...
zones.november:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='november-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='november-sam-red'}),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='november-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='november-sam-blue'}),
...
zones.intelcenter:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='intelcenter-garrison-red'})
            }
        }),
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='intelcenter-garrison-blue'})
            }
        }),
        presets.upgrades.supply.hq:extend({
...
zones.factory:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='factory-garrison-red'})
            }
        }),
        presets.upgrades.supply.factory:extend({
    ...
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='factory-garrison-blue'})
            }
        }),
        presets.upgrades.supply.factory:extend({
...
zones.unal:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='unal-tent-red',
            products = {
                presets.defenses.infantry:extend({name='unal-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='unal-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='unal-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='unal-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='unal-fuel-blue',
...
zones.babugent:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='babugent-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='babugent-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.terek:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='terek-tent-red',
            products = {
                presets.defenses.infantry:extend({name='terek-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='terek-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='terek-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.alpha:defineUpgrades({
    [1] = --red side
    {
        presets.upgrades.basic.tent:extend({ 
            name = 'alpha-tent-red',
            products = {
                presets.defenses.infantry:extend({ name='alpha-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({ 
            name = 'alpha-fuel-red',
    ...
    {	
        presets.upgrades.basic.tent:extend({ 
            ...
            products = {
                presets.defenses.infantry:extend({ name='alpha-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({ 
...
zones.oni:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='oni-tent-red',
            products = {
                presets.defenses.infantry:extend({name='oni-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='oni-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='oni-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='oni-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='oni-fuel-blue',
...
zones.tyrnyauz:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='tyrnyauz-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='tyrnyauz-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [1] =  
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                ...
                presets.defenses.infantry:extend({name='zugdidi-garrison-red'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='zugdidi-sam-red'})
            }
        })
    },
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                ...
                presets.defenses.infantry:extend({name='zugdidi-garrison-blue'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='zugdidi-sam-blue'})
            }
        })
    }
})
...
zones.kilo:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='kilo-tent-red',
            products = {
                presets.defenses.infantry:extend({name='kilo-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='kilo-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='kilo-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='kilo-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='kilo-fuel-blue',
...
zones.oscar:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='oscar-tent-red',
            products = {
                presets.defenses.infantry:extend({name='oscar-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
            name='oscar-fuel-red',
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='oscar-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.oilfields:defineUpgrades({
    [1] = {
        presets.upgrades.basic.outpost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='oilfields-garrison-red'})
            }
        }),
    ...
    [2] = {
        presets.upgrades.basic.outpost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='oilfields-garrison-blue'})
            }
        }),
        presets.upgrades.supply.oilPump:extend({
...
zones.uniform:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='uniform-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='uniform-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.kislovodsk:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='kislovodsk-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='kislovodsk-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelCache:extend({
...
zones.golf:defineUpgrades({
    [1] = {
        presets.upgrades.basic.tent:extend({
            name='golf-tent-red',
            products = {
                presets.defenses.infantry:extend({name='golf-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
            name='golf-fuel-red',
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='golf-sam-red'}),
    ...
    [2] = {
        presets.upgrades.basic.tent:extend({
            name='golf-tent-blue',
            products = {
                presets.defenses.infantry:extend({name='golf-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
            name='golf-fuel-blue',
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.lightsam:extend({name='golf-sam-blue'}),
...
zones.mozdok:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='mozdok-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mozdok-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='mozdok-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='mozdok-airdef-blue'}),
...
zones.sochi:defineUpgrades({
    [1] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='sochi-garrison-red'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
            name='sochi-fuel-red',
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='sochi-airdef-red'}),
    ...
    [2] = 
    {
        presets.upgrades.basic.comPost:extend({
            ...
            products = {
                presets.defenses.infantry:extend({ name='sochi-garrison-blue'})
            }
        }),
        presets.upgrades.supply.fuelTank:extend({
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='sochi-airdef-blue'}),
...
zones.tallyk:defineUpgrades({
    [1] =  
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='tallyk-garrison-red'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='tallyk-sam-red'})
            }
        })
    },
    [2] = 
    {
        presets.upgrades.basic.tent:extend({
            ...
            products = {
                presets.defenses.infantry:extend({name='tallyk-garrison-blue'}),
        ...
        presets.upgrades.airdef.comCenter:extend({
            ...
            products = {
                presets.defenses.sam:extend({ name='tallyk-sam-blue'})
            }
        })
    }
})
...
-- PlayerLogistics:registerSquadGroup(squadType,              groupname,                    weight,cost,jobtime,extracttime)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.capture,  'blue-capture-squad-template',  700, 200, 60,    60*30)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.sabotage, 'blue-sabotage-squad-template', 800, 500, 60*5,  60*30)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.ambush,   'blue-ambush-squad-template',   900, 300, 60*20, 60*30)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.engineer, 'blue-engineer-squad-template', 200, 1000,60,    60*30)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.manpads,  'blue-manpads-squad-template',  900, 500, 60*20, 60*30)

pm = PersistenceManager:new(savefile, gm)
pm:load()
