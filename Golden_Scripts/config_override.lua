...
Config.carrierSpawnCost = 250 -- resource cost for carrier when players take off, set to 0 to disable restriction
Config.zoneSpawnCost = 100 -- resource cost for zones when players take off, set to 0 to disable restriction
