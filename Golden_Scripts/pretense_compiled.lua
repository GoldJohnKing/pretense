...
do
	...
	function BattlefieldManager:start()
		...
		timer.scheduleFunction(function(param, time)
			local x = math.random(0,100) -- the lower limit benefits blue, higher limit benefits red, adjust to increase limit of random boost variance, default (-50,50) -- Edited, benefit red more, default = -50,50
